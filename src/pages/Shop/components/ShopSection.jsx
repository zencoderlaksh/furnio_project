  ...
  return (
    <div class="relative">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  flex flex-col items-center text-center px-4">
        ...
        <h1 className="text-3xl sm:text-4xl font-semibold text-gray-800">Shop</h1>
        <h6 className="text-sm sm:text-base text-gray-700"><span className='font-bold'>Home &gt;</span> shop</h6>
      </div>
    </div>
  )
}
